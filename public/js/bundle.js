...
},{}],"mailbox.js":[function(require,module,exports) {
"use strict";
...
var hideAlert = exports.hideAlert = function hideAlert() {
  ...
  if (el) el.parentElement.removeChild(el), _readOnlyError("el");
};
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('sucess', 'Logged in successfully');
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://127.0.0.1:3000/app/v1/users/updateMyPassword' : 'http://127.0.0.1:3000/app/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('sucess', "".concat(type.toUpperCase(), " updated successfully"));
          }
          _context.next = 11;
          break;
        case 8:
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /*eslint-disable*/
var stripe = Stripe("pk_test_51OURzdSCwAB3MSmLu0XULVxlfWMNLMARninW3Fe5UwRO5NuJuIepuvZGGJwrUwaMTRb7917UKZbDLISGNhy5oQ8q00G4fJNB2t");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://127.0.0.1:3000/app/v1/bookings/checkout-sesion/".concat(tourId));
        case 3:
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _login.login)(emailField, passwordField);
  });
}
if (logoutBtn) {
  logoutBtn.addEventListener('submit', _login.logout);
}
if (updateUser) {
